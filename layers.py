...
class SN(object):
  def __init__(self, num_svs, num_itrs, num_outputs, transpose=False):
...
class SNLinear(nn.Linear, SN):
  def __init__(self, in_features, out_features, bias=True,
    ...
    SN.__init__(self, num_svs, num_itrs, out_features)
  def forward(self, x):
...
class SNEmbedding(nn.Embedding, SN):
  def __init__(self, num_embeddings, embedding_dim, padding_idx=None, 
    ...
    nn.Embedding.__init__(self, num_embeddings, embedding_dim, padding_idx,
                          ...
                          sparse, _weight)
    SN.__init__(self, num_svs, num_itrs, num_embeddings)# num_embeddings, transpose=True)
  def forward(self, x):
